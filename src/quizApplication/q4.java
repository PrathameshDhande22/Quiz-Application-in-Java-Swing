...
public class q4  extends JFrame {
	...
	String s1;
	int c;
	public q4(String name,int m,int count) {
		s1=name;
		m1=m;
		c=count;
		setTitle("Question 4");
...
addWindowListener(new WindowListener() {
		...
		JLabel lblNewLabel = new JLabel("4. Which of the Following is true about String ?");
		lblNewLabel.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		lblNewLabel.setBounds(10, 31, 389, 24);
		contentPane.add(lblNewLabel);
		
		JRadioButton opt1 = new JRadioButton("String is mutable");
		...
		JRadioButton opt2 = new JRadioButton("String is immutable");
		...
		JRadioButton opt3 = new JRadioButton("String is a data type");
