...
public class q10  extends JFrame {
	...
	public q10(String name,int m,int count) {
		...
		JLabel lblNewLabel = new JLabel("10. Which component is used to compile debug and execute the java programs ?");
		lblNewLabel.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		lblNewLabel.setBounds(10, 31, 389, 24);
		contentPane.add(lblNewLabel);
		
		JRadioButton opt1 = new JRadioButton("JRE");
		...
		JRadioButton opt2 = new JRadioButton("JIT");
		...
		JRadioButton opt3 = new JRadioButton("JDK");
		...
		JRadioButton opt4 = new JRadioButton("JVM");
