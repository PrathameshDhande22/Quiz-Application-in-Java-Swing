...
public class q3  extends JFrame {
	...
	String s1;
	int c;
	public q3(String name,int m,int count) {
		s1=name;
		m1=m;
		c=count;
		setTitle("Question 3");
...
addWindowListener(new WindowListener() {
		...
		JLabel lblNewLabel = new JLabel("3. What is the default value of float variable ?");
		lblNewLabel.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		lblNewLabel.setBounds(10, 31, 389, 24);
		contentPane.add(lblNewLabel);
		
		JRadioButton opt1 = new JRadioButton("0.0d");
		...
		JRadioButton opt2 = new JRadioButton("0.0f");
		...
		JRadioButton opt3 = new JRadioButton("0");
		...
		JRadioButton opt4 = new JRadioButton("Not Defined");
