...
public class q9  extends JFrame {
	...
	String s1;
	int c;
	public q9(String name,int m,int count) {
		s1=name;
		m1=m;
		c=count;
		setTitle("Question 9");
...
addWindowListener(new WindowListener() {
		...
		JLabel lblNewLabel = new JLabel("9. Who invented java Programming ?");
		lblNewLabel.setFont(new Font("Times New Roman", Font.PLAIN, 15));
		lblNewLabel.setBounds(10, 31, 389, 24);
		contentPane.add(lblNewLabel);
		
		JRadioButton opt1 = new JRadioButton("Guidd van Rossum");
		...
		JRadioButton opt2 = new JRadioButton("James Gosling");
		...
		JRadioButton opt3 = new JRadioButton("Dennis Ritchie");
		...
		JRadioButton opt4 = new JRadioButton("Bjarne Stroustrup");
		...
		next.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				if(opt2.isSelected()) {
					m1=m1+5;
					c=c+1;
					q10 question10=new q10(s1,m1,c);
					question10.setVisible(true);
					dispose();
				}
				else if(opt1.isSelected()==false && opt4.isSelected()==false && opt3.isSelected()==false ) {
